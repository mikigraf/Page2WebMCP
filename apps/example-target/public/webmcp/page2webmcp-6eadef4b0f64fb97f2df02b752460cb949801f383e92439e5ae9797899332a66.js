...
export const releaseManifest = deepFreeze({"version":3,"rendererId":"fb47b343e042561a8d884b6d3a77d99eb1a114aa31b0c79378b9adeeb1291274","releaseId":"c3cc3d9c77842e14e089caaddaf984f864b63f93aaeaa8100e232436ccb61eaf","integrityPolicy":{"enforcement":"trusted-loader-required","algorithms":["sha256","sha384"]},"targetOrigin":"https://page2webmcp-example-target.vercel.app","plans":[{"version":1,"targetOrigin":"https://page2webmcp-example-target.vercel.app","tool":{"name":"getpart_d66cf71e","title":"GET /api/parts/{sku}","description":"Read data from the reviewed API operation."},"schemas":{"input":{"type":"object","properties":{"path_sku":{"type":"string","minLength":1,"maxLength":64}},"required":["path_sku"],"additionalProperties":false},"output":{"type":"object","properties":{"available":{"type":"integer","minimum":0},"name":{"type":"string"},"onHand":{"type":"integer","minimum":0},"reserved":{"type":"integer","minimum":0},"sku":{"type":"string"},"supplierNotes":{"type":"string"},"untrustedContent":{"type":"boolean"}},"required":["available","name","onHand","reserved","sku","supplierNotes","untrustedContent"],"additionalProperties":false}},"annotations":{"readOnly":true,"untrusted":false},"authentication":{"mode":"same_origin_cookie","requiredScopes":[]},"effects":{"kind":"read","riskTier":"R0","reversible":true,"summary":"Reads reviewed API data without mutation.","confirmation":"none"},"idempotency":{"strategy":"none","verified":false,"retry":"safe_once"},"request":{"adapter":"json_api","method":"GET","pathTemplate":"/api/parts/{path_sku}","path":{"path_sku":"path_sku"},"query":{},"headers":{},"body":{},"optional":[],"bodyEncoding":"json"},"response":{"adapter":"json_api","contentTypes":["application/json"],"projection":{"kind":"identity"},"errorMappings":{"400":"VALIDATION_FAILED","401":"AUTHENTICATION_REQUIRED","404":"STALE_TARGET","default":"TARGET_ERROR"}},"success":{"adapter":"json_api","statusCodes":[200],"requiredOutputFields":[]},"evidence":[{"source":"openapi","reference":"urn:sha256:e638bbbc02f130aa4299bfe5f776bd950486136e27bf468de71ebb876790f4f3"}]},{"version":1,"targetOrigin":"https://page2webmcp-example-target.vercel.app","tool":{"name":"getreservation_3a067ad2","title":"GET /api/reservations/{id}","description":"Read data from the reviewed API operation."},"schemas":{"input":{"type":"object","properties":{"path_id":{"type":"string","minLength":1,"maxLength":128}},"required":["path_id"],"additionalProperties":false},"output":{"type":"object","properties":{"createdAt":{"type":"string","minLength":20,"maxLength":40},"orderReference":{"type":"string"},"quantity":{"type":"integer","minimum":1,"maximum":99},"releasedAt":{"type":"string","maxLength":40},"reservationId":{"type":"string"},"sku":{"type":"string"},"status":{"type":"string","enum":["released","reserved"]}},"required":["createdAt","orderReference","quantity","releasedAt","reservationId","sku","status"],"additionalProperties":false}},"annotations":{"readOnly":true,"untrusted":false},"authentication":{"mode":"same_origin_cookie","requiredScopes":[]},"effects":{"kind":"read","riskTier":"R0","reversible":true,"summary":"Reads reviewed API data without mutation.","confirmation":"none"},"idempotency":{"strategy":"none","verified":false,"retry":"safe_once"},"request":{"adapter":"json_api","method":"GET","pathTemplate":"/api/reservations/{path_id}","path":{"path_id":"path_id"},"query":{},"headers":{},"body":{},"optional":[],"bodyEncoding":"json"},"response":{"adapter":"json_api","contentTypes":["application/json"],"projection":{"kind":"identity"},"errorMappings":{"400":"VALIDATION_FAILED","401":"AUTHENTICATION_REQUIRED","404":"STALE_TARGET","default":"TARGET_ERROR"}},"success":{"adapter":"json_api","statusCodes":[200],"requiredOutputFields":[]},"evidence":[{"source":"openapi","reference":"urn:sha256:e638bbbc02f130aa4299bfe5f776bd950486136e27bf468de71ebb876790f4f3"}]},{"version":1,"targetOrigin":"https://page2webmcp-example-target.vercel.app","tool":{"name":"listparts_bbb123f7","title":"GET /api/parts","description":"Read data from the reviewed API operation."},"schemas":{"input":{"type":"object","properties":{"query_q":{"type":"string","minLength":1,"maxLength":120}},"required":[],"additionalProperties":false},"output":{"type":"array","items":{"type":"object","properties":{"available":{"type":"integer","minimum":0},"name":{"type":"string"},"sku":{"type":"string","minLength":1,"maxLength":64}},"required":["available","name","sku"],"additionalProperties":false},"maxItems":100}},"annotations":{"readOnly":true,"untrusted":false},"authentication":{"mode":"same_origin_cookie","requiredScopes":[]},"effects":{"kind":"read","riskTier":"R0","reversible":true,"summary":"Reads reviewed API data without mutation.","confirmation":"none"},"idempotency":{"strategy":"none","verified":false,"retry":"safe_once"},"request":{"adapter":"json_api","method":"GET","pathTemplate":"/api/parts","path":{},"query":{"q":"query_q"},"headers":{},"body":{},"optional":["query_q"],"bodyEncoding":"json"},"response":{"adapter":"json_api","contentTypes":["application/json"],"projection":{"kind":"identity"},"errorMappings":{"400":"VALIDATION_FAILED","401":"AUTHENTICATION_REQUIRED","default":"TARGET_ERROR"}},"success":{"adapter":"json_api","statusCodes":[200],"requiredOutputFields":[]},"evidence":[{"source":"openapi","reference":"urn:sha256:e638bbbc02f130aa4299bfe5f776bd950486136e27bf468de71ebb876790f4f3"}]},{"version":1,"targetOrigin":"https://page2webmcp-example-target.vercel.app","tool":{"name":"listreservations_76fd9d39","title":"GET /api/reservations","description":"Read data from the reviewed API operation."},"schemas":{"input":{"type":"object","properties":{},"required":[],"additionalProperties":false},"output":{"type":"array","items":{"type":"object","properties":{"createdAt":{"type":"string","minLength":20,"maxLength":40},"orderReference":{"type":"string"},"quantity":{"type":"integer","minimum":1,"maximum":99},"releasedAt":{"type":"string","maxLength":40},"reservationId":{"type":"string"},"sku":{"type":"string"},"status":{"type":"string","enum":["released","reserved"]}},"required":["createdAt","orderReference","quantity","releasedAt","reservationId","sku","status"],"additionalProperties":false},"maxItems":100}},"annotations":{"readOnly":true,"untrusted":false},"authentication":{"mode":"same_origin_cookie","requiredScopes":[]},"effects":{"kind":"read","riskTier":"R0","reversible":true,"summary":"Reads reviewed API data without mutation.","confirmation":"none"},"idempotency":{"strategy":"none","verified":false,"retry":"safe_once"},"request":{"adapter":"json_api","method":"GET","pathTemplate":"/api/reservations","path":{},"query":{},"headers":{},"body":{},"optional":[],"bodyEncoding":"json"},"response":{"adapter":"json_api","contentTypes":["application/json"],"projection":{"kind":"identity"},"errorMappings":{"401":"AUTHENTICATION_REQUIRED","default":"TARGET_ERROR"}},"success":{"adapter":"json_api","statusCodes":[200],"requiredOutputFields":[]},"evidence":[{"source":"openapi","reference":"urn:sha256:e638bbbc02f130aa4299bfe5f776bd950486136e27bf468de71ebb876790f4f3"}]},{"version":1,"targetOrigin":"https://page2webmcp-example-target.vercel.app","tool":{"name":"reservepartstock_322c76cc","title":"POST /api/reservations","description":"Run the reviewed API mutation."},"schemas":{"input":{"type":"object","properties":{"body_confirmed":{"type":"boolean"},"body_orderreference":{"type":"string","minLength":3,"maxLength":64},"body_quantity":{"type":"integer","minimum":1,"maximum":99},"body_sku":{"type":"string","minLength":1,"maxLength":64}},"required":["body_confirmed","body_orderreference","body_quantity","body_sku"],"additionalProperties":false},"output":{"type":"object","properties":{"createdAt":{"type":"string","minLength":20,"maxLength":40},"effectCount":{"type":"integer","minimum":1,"maximum":1},"orderReference":{"type":"string"},"quantity":{"type":"integer","minimum":1,"maximum":99},"reservationId":{"type":"string"},"reversible":{"type":"boolean"},"sku":{"type":"string"},"status":{"type":"string","enum":["reserved"]}},"required":["createdAt","effectCount","orderReference","quantity","reservationId","reversible","sku","status"],"additionalProperties":false}},"annotations":{"readOnly":false,"untrusted":false},"authentication":{"mode":"same_origin_cookie","requiredScopes":[],"csrf":{"reviewed":true,"headerName":"x-csrf-token","resolution":{"kind":"meta","name":"csrf-token","attribute":"content"}}},"effects":{"kind":"mutation","riskTier":"R1","reversible":true,"summary":"Performs the reviewed API mutation.","confirmation":"always"},"idempotency":{"strategy":"header","headerName":"idempotency-key","verified":true,"retry":"safe_once"},"request":{"adapter":"json_api","method":"POST","pathTemplate":"/api/reservations","path":{},"query":{},"headers":{},"body":{"confirmed":"body_confirmed","orderReference":"body_orderreference","quantity":"body_quantity","sku":"body_sku"},"optional":[],"bodyEncoding":"json"},"response":{"adapter":"json_api","contentTypes":["application/json"],"projection":{"kind":"identity"},"errorMappings":{"400":"VALIDATION_FAILED","401":"AUTHENTICATION_REQUIRED","403":"FORBIDDEN","404":"STALE_TARGET","409":"VALIDATION_FAILED","413":"TARGET_ERROR","default":"TARGET_ERROR"}},"success":{"adapter":"json_api","statusCodes":[201],"requiredOutputFields":[]},"evidence":[{"source":"openapi","reference":"urn:sha256:e638bbbc02f130aa4299bfe5f776bd950486136e27bf468de71ebb876790f4f3"}]}]});
